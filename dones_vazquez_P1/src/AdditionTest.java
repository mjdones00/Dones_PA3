...
public class AdditionTest {
    ...
    private static double userAddInput;
    ...
    public int generateNewTest(Scanner scnr, SecureRandom rand, int numRuns, int numSize) {
        ...
        while(numRuns > 0) {
            ...
            double addition = (double) num1 + num2;


            System.out.println("How much is " + num1 + " plus " + num2 + "?");
            userAddInput = scnr.nextDouble();
            if (Double.compare(userAddInput, addition) == 0) {
                System.out.println(pseudoRanPositive(rand));
                rightCounter++;
            }
            else if (Double.compare(userAddInput, addition) !=0) {
